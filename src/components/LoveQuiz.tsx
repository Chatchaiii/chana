  ...
  const questions = [
    {
      ...
      correct: 1,
      explanation: "You always notice how much I love pink! 💕"
    },
    {
      question: "What's our favorite place to go together?",
      options: ["Coffee shop", "Park", "Beach", "Movies"],
      correct: 0,
      explanation: "Our coffee dates are the best! ☕️"
    },
    {
    ...
    },
    {
      ...
      options: ["Your jokes", "Funny movies", "Cute animals", "Our inside jokes"],
      correct: 3,
      explanation: "Our silly inside jokes always crack me up! 😄"
    },
    {
      ...
      <div className="p-6 space-y-6">
        ...
        <Card className="p-6 text-center space-y-6">
          ...
          <div className="space-y-3">
            <Button onClick={resetQuiz} className="w-full bg-gray-600 hover:bg-gray-700">
              Take Quiz Again
            </Button>
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Card className="p-6 space-y-6">
        ...
        {/* Next Button */}
        {answered && (
          <Button onClick={handleNext} className="w-full bg-gray-600 hover:bg-gray-700">
